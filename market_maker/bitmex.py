...
class BitMEX(object):
    ...
    def __init__(self, base_url=None, symbol=None, apiKey=None, apiSecret=None,orderIDPrefix='mm_bitmex_', shouldWSAuth=True, postOnly=False, timeout=7):
        """Init connector."""
...
2
    ...
    @authentication_required
    def place_order(self, quantity, price=None, ordType=None):
        """Place an order."""
    ...
    def _curl_bitmex(self, path, query=None, postdict=None, timeout=None, verb=None, rethrow_errors=False,max_retries=None):
